...
def get_generated_qa():
    ...
    ]  # find ends of each context sentence
    ans_cntxt = []
    for ans in answers:
    ...
    for ac_pair in ans_cntxt:
        ...
        output = nlp.qg_model.generate(
            input_ids=features["input_ids"],
            attention_mask=features["attention_mask"],
            max_length=64,
        )  # max_length is tunable
...
def get_generated_qa2():
    ...
    # Summarize
    summary = nlp.summarizer(text, max_length=260, min_length=200, do_sample=False)[0][
        "summary_text"
    ]
    print("====================== summary ===================")
    print(summary)
